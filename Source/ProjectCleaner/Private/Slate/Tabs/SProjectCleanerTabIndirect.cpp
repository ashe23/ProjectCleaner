...
//
// 	ListItems.Reset();
// 	const auto IndirectAssets = GEditor->GetEditorSubsystem<UProjectCleanerSubsystem>()->GetAssetsIndirect();
// 	TotalSize = GEditor->GetEditorSubsystem<UProjectCleanerSubsystem>()->GetAssetsTotalSize(IndirectAssets);
//
// 	for (const auto& IndirectAsset : GEditor->GetEditorSubsystem<UProjectCleanerSubsystem>()->GetIndirectAssetsInfo())
// 	{
